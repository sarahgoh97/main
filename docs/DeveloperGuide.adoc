...
Since the app is still being tested, the map command will also show in the result display box.
...
image::AddCellSequenceDiagram.PNG[width="400"]
image::AddCellModelSequenceDiagram.PNG[width="400"]
