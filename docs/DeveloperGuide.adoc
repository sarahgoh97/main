...
It opens an additional calendar window with its own command input.
...
The PrisonBook Calendar will send a HTTPS request to the Google Calendar API and change the Google account calendar.
Upon confirmation of successful change by the Google Calendar APIR, the change will be reflected in the PrisonBook Calendar window.
...
Cons: Not as intuitive as selecting timeslots to edit. Need more prefixes for users to learn.
* Alternative 2: Have buttons for users to click to edit.
 Pros: More intutitive as less things to type.
