...
==== View upcoming events in the calendar: `calendar or c` (v1.3)
Format: `calendar`

==== View upcoming events in the calendar: `calAdd or calA` (v1.3)
...
//tag::deletecell[]
=== Deleting a person from a cell : `deletecell or dc` (v1.4)
