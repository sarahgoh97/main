...
=== Adding a prisoner to a cell: `addcell or ac` (upcoming)
...
=== Listing prisoners in a cell : `listcell or lc` (upcoming)
...
=== Deleting a person from a cell : `deletecell or dc` (upcoming)
