...
*** Find by tags command (Pull requests https://github.com/CS2103JAN2018-T11-B2/main/pull/25[#25])
*** View upcoming events from PrisonBook Google Calendar (Pull requests https://github.com/CS2103JAN2018-T11-B2/main/pull/55[#55])
** Documentation:
