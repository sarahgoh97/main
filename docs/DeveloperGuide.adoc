...
** Cons: Anyone walking by from behind can see the information easily.
...
Easier to delete prisoners from cells and update their addresses accordingly.
** Cons: Need to have extra implementation to ensure undo and redo commands work properly when deleting a prisoner who is imprisoned.
...
** Pros: Faster way to remove since only the index of the prisoner is required.
