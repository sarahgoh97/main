...
=== Adding a prisoner to a cell: `addcell or ac` (Partially here in v1.2)
...
=== Showing cells in the map: `map or m` (Here in v1.1)
...
==== View upcoming events in the calendar: `calendar or c`
Format: `calendar`
