...
=== Adding a prisoner to a cell: `addcell or ac` (incomplete)

Adds a person to one of the cells in the prison +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`

[TIP]
A person must have at least a prisoner tag

Examples:

* `addcell n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 t/prisoner`
* `ac n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/prisoner`
...
=== Listing prisoners in a cell : `listcell or lc` (incomplete)

Shows a list of all persons in a prison cell in the address book. +
Format: `list CELL`
...
=== Deleting a person from a cell : `deletecell or dc` (incomplete)
...
Clears all entries from the address book. Clears all prison cells. +
Format: `clear`
